        ...
        <main>
            ...
            <form onSubmit={handleSendQuestion}>
                ...
                <div className='form-footer'> 
                    ...
                    <Button onClick={handleSendQuestion} disabled={!user} type='submit'>
                        Enviar Pergunta
                    </Button>
                </div>
            </form>
            ...
            <div className='question-list'>
                {questions.map((item, index) => <Question isAnswered={item.isAnswered} isHighlighted={item.isHighlighted} content={item.content} key={index} author={item.author}>
                    {!item.isAnswered && (
                        <button
